...
export const COLLECTION_DOCUMENTS_AUTOCOMPLETE_SET_TERM = 'COLLECTION_DOCUMENTS_AUTOCOMPLETE_SET_TERM'
export const autocompleteCollectionSetTerm = (term) => ({
  type: COLLECTION_DOCUMENTS_AUTOCOMPLETE_SET_TERM,
  payload: { term }
})

export const COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH = 'COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH'
export const autocompleteCollectionSearch = (term) => ({
  type: COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH,
  payload: { term }
})

export const COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH_LOADING = 'COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH_LOADING'
export const COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH_SUCCESS = 'COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH_SUCCESS'
export const COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH_FAILURE = 'COLLECTION_DOCUMENTS_AUTOCOMPLETE_SEARCH_FAILURE'

export const COLLECTION_DOCUMENTS_AUTOCOMPLETE_CLEAR = 'COLLECTION_DOCUMENTS_AUTOCOMPLETE_CLEAR'
export const autocompleteCollectionClear = () => ({
  type: COLLECTION_DOCUMENTS_AUTOCOMPLETE_CLEAR,
})
