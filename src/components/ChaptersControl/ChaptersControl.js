  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="Theme__title d-lg-none d-flex align-items-center justify-content-center animated fadeInDown ChaptersControl__delay">
        ...
        <div className="ChaptersControl__chapters_num_container animated fadeInRight ChaptersControl__delay">
          <span className="AtlasGrotesk-Medium-Web d-none d-lg-block ChaptersControl__chapters_num_container_title" onClick={onClickTheme}>{title}</span>
        ...
        <div className="ChaptersControl__controls_container d-none d-lg-block animated fadeInRight ChaptersControl__delay">
        ...
        <div className="ChaptersControl__controls_container_mobile d-flex d-lg-none animated fadeInUp ChaptersControl__delay">
          <div className="w-50">
